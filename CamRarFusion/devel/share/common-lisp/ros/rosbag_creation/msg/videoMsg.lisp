...
(cl:defclass <videoMsg> (roslisp-msg-protocol:ros-message)
  ((vName
    :reader vName
    :initarg :vName
    :type cl:string
...
(cl:defclass videoMsg (<videoMsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <videoMsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'videoMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag_creation-msg:<videoMsg> is deprecated: use rosbag_creation-msg:videoMsg instead.")))

(cl:ensure-generic-function 'vName-val :lambda-list '(m))
(cl:defmethod vName-val ((m <videoMsg>))
...
(cl:defmethod frame-val ((m <videoMsg>))
...
(cl:defmethod radarRange-val ((m <videoMsg>))
...
(cl:defmethod radarAngle-val ((m <videoMsg>))
...
(cl:defmethod camTick-val ((m <videoMsg>))
...
(cl:defmethod radarTick-val ((m <videoMsg>))
...
(cl:defmethod lateralDist-val ((m <videoMsg>))
...
(cl:defmethod targetID-val ((m <videoMsg>))
...
(cl:defmethod dataConfidence-val ((m <videoMsg>))
  ...
  (dataConfidence m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <videoMsg>) ostream)
  "Serializes a message object of type '<videoMsg>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <videoMsg>) istream)
  "Deserializes a message object of type '<videoMsg>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<videoMsg>)))
  "Returns string type for a message object of type '<videoMsg>"
  "rosbag_creation/videoMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'videoMsg)))
  "Returns string type for a message object of type 'videoMsg"
  "rosbag_creation/videoMsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<videoMsg>)))
  "Returns md5sum for a message object of type '<videoMsg>"
  "f13598e7a6de6888828400fe1afcd644")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'videoMsg)))
  "Returns md5sum for a message object of type 'videoMsg"
  "f13598e7a6de6888828400fe1afcd644")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<videoMsg>)))
  "Returns full string definition for message of type '<videoMsg>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'videoMsg)))
  "Returns full string definition for message of type 'videoMsg"
  (cl:format cl:nil "string vName~%int16 frame~%float64 radarRange~%float64 radarAngle~%int64 camTick~%int64 radarTick~%float64 lateralDist~%int8 targetID~%int8 dataConfidence~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <videoMsg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <videoMsg>))
